...
@interface ChatRoomVC () <UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,EMChatManagerDelegate>
...
//    [self sendMessage:@"不认识!" withType:CZMessageTypeOther];
    ...
    //生成Message
    EMMessage *message = [[EMMessage alloc] initWithConversationID:@"6001" from:from to:@"1234" body:body ext:nil];
...
- (void)didReceiveMessages:(NSArray *)aMessages
{
    ...
    [self sendMessage:textBody.text withType:CZMessageTypeOther];
}
...
- (void)keyboardWillChangeFrame:(NSNotification *)noteInfo
{
    ...
    CGFloat tranformValue = keyboardY - (self.view.frame.size.height+64);
